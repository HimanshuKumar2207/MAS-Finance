    ...
    <div className="relative">
      ...
      <div className="absolute top-0 left-0 w-full h-[400px] sm:h-[500px] md:h-[600px] lg:h-[850px] flex flex-col justify-center items-center">
        ...
        <motion.h1
          ...
          className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-[80px] font-semibold text-center font-montserrat mb-6 sm:mb-8 md:mb-10 lg:mb-4"
        >
          {heading}
        </motion.h1>
